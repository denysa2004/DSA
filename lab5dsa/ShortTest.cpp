...
void testAll1() {
	...
	assert(s2.add(100) == true);      //testele facute pt functia suplimentara
	assert(s2.add(111)==true);

	assert(s1.inorderDifference(s1,s2)==1);
	assert(s1.inorderDifference(s1,s2)==10);
	assert(s1.inorderDifference(s1,s2)==100);
	assert(s1.inorderDifference(s1,s2)==20);
	assert(s1.inorderDifference(s1,s2)==10);
